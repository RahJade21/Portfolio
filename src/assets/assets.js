...
export const techStack = [
  ...
  { id: 11, name: "tailwindcss",  logo: tailwind,   color: "#38B2AC" },
  { id: 12, name: "Terraform",    logo: terraform,  color: "#623CE4" },
  { id: 13, name: "Postman",      logo: postman,    color: "#FF6C37" },
  { id: 14, name: "VSCode",       logo: vscode,     color: "#007ACC" },
  { id: 15, name: "Wireshark",    logo: wireshark,  color: "#1876C9" },
  { id: 16, name: "Autopsy",      logo: autopsy,    color: "#E54B4B" },
  { id: 17, name: "BurpSuite",    logo: burpsuite,  color: "#E54B4B" },
];
...
export const projects = [
  ...
  },
  {
    ...
    liveUrl: "https://nike-website-psi-gilt.vercel.app/",
    featured: false,
  },
  {
    id: 6,
    ...
    liveUrl: "https://bank-modern-app-plum-three.vercel.app/",
    featured: false,
  },
  {
    id: 7,
